...
In This second series of web stack debugging projects, I was given broken/bugged webstacks in isolated containers,
and tasked with the responsibility of fixing the web stack to a working state. 
For each
